...
class DesttwoPage extends StatefulWidget {
  const DesttwoPage({Key? key}) : super(key: key);

  @override
  State<DesttwoPage> createState() => _DesttwoPageState();
}

class _DesttwoPageState extends State<DesttwoPage> {
  @override
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                              height:
                                  0.030 * MediaQuery.of(context).size.height),
                          Text(
